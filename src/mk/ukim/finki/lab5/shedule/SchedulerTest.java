package mk.ukim.finki.lab5.shedule;
...
class Timestamp<T> implements Comparable<Timestamp<?>>
{
    ...
    public boolean equals(Object obj) {
        ...
        return this.time.equals(temp.time);
    }
...
class Scheduler<T>
{
    ...
    public boolean remove(Timestamp<Integer> integerTimestamp) {
        if(timestamps.contains(integerTimestamp))
        {
            timestamps.remove(integerTimestamp);
            return true;
        }
        return false;
    }

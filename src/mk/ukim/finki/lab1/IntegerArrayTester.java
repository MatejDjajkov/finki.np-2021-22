...
final class IntegerArray
{
    ...
    public IntegerArray concat(IntegerArray ai)
    {
        int res_a[]= new int[ai.length()+a.length];
        System.arraycopy(a,0,res_a,0,a.length);
        System.arraycopy(ai.a,0,res_a,a.length,ai.a.length);
        return new IntegerArray(res_a);

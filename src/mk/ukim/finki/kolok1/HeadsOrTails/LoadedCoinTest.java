package mk.ukim.finki.kolok1.HeadsOrTails;
...
class LoadedCoin extends Coin {
    private int headsprobability;

    public LoadedCoin(int probability) {
        this.headsprobability = probability;
    }
    public SIDE flip()
    {
        int tailsprobability=100-headsprobability;
        int variable= new Random().nextInt(100)+1;
        if(variable>tailsprobability)
        {
            return SIDE.HEAD;
        }
        return SIDE.TAIL;

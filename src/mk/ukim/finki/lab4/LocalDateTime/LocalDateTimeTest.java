package mk.ukim.finki.lab4.LocalDateTime;
...
public class LocalDateTimeTest {
    ...
    static LocalDateTime localDateTimeOf() {
        ...
        return LocalDateTime.of(2015,06,20,23,7,30);
    }
    ...
    static LocalDateTime localTimeWith() {
         ...
         */
        return ldt.plusDays(13).truncatedTo(ChronoUnit.HOURS);
    }
    ...
    static String localDateTimeFormat() {
         ...
         */
        return ldt.format(DateTimeFormatter.ofPattern("yyyy_MM_dd_HH_mm_s"));
    }
